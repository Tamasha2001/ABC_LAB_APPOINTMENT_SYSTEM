        ...
        <div class="dashboard-container" style="margin-top: 80px">
            ...
            <div class="admin-content" id="manageTechnicianContent" style="margin-top: 50px;">
                <section id="manageTechnician" class="container">
                    ...
                    <div class="technician-details-table" id="manageTechnicianContent">
                        <section id="techniciandetails" class="containers">
                            <h2 class="dashboard-heading">View Technician</h2>
                            <br>
                            <table id="technicianDetailsTable" class="technician-details-table">
                                <thead>
                                    <tr>
                                        <th>Technician ID</th>
            ...
            <div class="admin-content" id="managePatientsContent">
                <section id="managePatients" class="container">
                   ...
                   <div class="patient-details-table" id="managePatientsContent">
                        <section id="patientdetails" class="containers">
                            <h2 class="dashboard-heading">View Patients</h2>
                            <br>
                            <table id="patientDetailsTable" class="patient-details-table">
                                <thead>
                                    <tr>
                                         <th>Patient ID</th>
                                        <th>Patient Name</th>
...
//****************************************************************************************************************
    ...
    $(document).ready(function () {
        fetch('http://localhost:8080/LAB-ABC-rest-service/resources/technician')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    var tableBody = $('#technicianTableBody');

                    tableBody.empty();

                    if (data.length === 0) {
                        tableBody.append('<tr><td colspan="5">No technician details found</td></tr>');
                    } else {
                        data.forEach(function (technician) {
                            var row = '<tr>' +
                                    '<td>' + technician.tid + '</td>' +
      ...
      $(document).ready(function () {
        ...
        fetch('http://localhost:8080/LAB-ABC-rest-service/resources/patient')
                ...
                .then(data => {
                    ...
                    if (data.length === 0) {
                        tableBody.append('<tr><td colspan="5">No patient details found</td></tr>');
                    } else {
