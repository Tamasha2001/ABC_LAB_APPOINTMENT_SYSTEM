...
public class TestDetails {
    ...
    public TestDetails(int test_id, String patient_name, String test_type, Date test_date, Time test_time, String technician_name, String referring_doctor, String result_DETAILS) {
